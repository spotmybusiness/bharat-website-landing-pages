      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <nav className="lg:col-span-3" aria-label="Services">
            ...
            <ul className="space-y-3 text-sm text-white/80">
              {services.map((service) => (
                <li key={service}>
                  <a href="#services" className="flex items-center gap-2 transition-colors hover:text-[#F28A32]">
                    <ArrowIcon />
                    {service}
                  </a>
                </li>
        ...
        <div className="flex flex-col items-center justify-between gap-4 pt-8 text-xs text-white/60 sm:flex-row">
          ...
          <div className="flex gap-6">
            <a href="#quote" className="transition-colors hover:text-white">Free Estimate</a>
