    ...
    <footer id="contact" className="bg-[#071A2B] text-white pt-20 pb-10 border-t border-white/10 relative overflow-hidden w-full max-w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 gap-12 border-b border-white/10 pb-12 md:grid-cols-2 lg:grid-cols-12 lg:gap-8">
          <section className="lg:col-span-4" aria-label="Company information">
            ...
            <div className="inline-flex max-w-full flex-wrap items-center gap-2 rounded-2xl border border-white/10 bg-white/5 p-3.5">
              <div className="flex items-center gap-1 text-[#F28A32]" aria-hidden="true">
                {[1, 2, 3, 4, 5].map((star) => (
          ...
          <nav className="lg:col-span-3" aria-label="Footer Services Navigation">
          ...
          <nav className="lg:col-span-2" aria-label="Footer Company Navigation">
        ...
        <div className="flex flex-col items-center justify-between gap-4 pt-8 text-xs text-white/60 sm:flex-row">
          ...
          <nav aria-label="Footer Quick Links" className="flex gap-6">
