    ...
    <>
      ...
      >
        <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12 flex items-center justify-between gap-4">
          ...
          <nav aria-label="Main Navigation" className="hidden xl:flex items-center gap-4 2xl:gap-6 shrink-0">
                  ...
                  >
                    <button
                      ...
                      className={`text-sm font-medium transition-colors py-1 focus:outline-none relative group whitespace-nowrap ${
                        servicesDropdownOpen || isServiceActive
                      ...
                      >
                        ...
                        <div className="bg-[#051525] border-t border-white/10 px-4 py-3 flex items-center justify-between text-xs">
                          <span className="text-slate-300 text-[11px]">
                            Need customized freight or shifting?
                          </span>
                          <Link
                            href="/get-a-quote"
                            onClick={() => setServicesDropdownOpen(false)}
                            className="text-[#F28A32] hover:text-[#ff9e47] font-bold inline-flex items-center gap-1 group/cta transition-colors text-xs"
                          >
          ...
          {/* Right Action Suite - Clean Single-Line Alignment */}
          <div className="hidden md:flex items-center gap-2 xl:gap-3 shrink-0">
            {/* Phone CTA Pill - Dial Now */}
            <a
              href={getTelUrl(BUSINESS.phone.primary)}
              className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#0c2438] hover:bg-[#122e47] text-white transition-all duration-200 group border border-white/10 shadow-sm whitespace-nowrap"
              title={`Dial ${BUSINESS.name}: ${BUSINESS.phone.primaryFormatted}`}
            >
              <span className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#E53935] text-white flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:bg-[#c62828] transition-all shadow-sm">
              ...
              <span className="text-xs xl:text-sm font-bold text-white tracking-normal group-hover:text-[#F28A32] transition-colors">
                Dial Now
              </span>
            </a>

            {/* WhatsApp CTA Pill - Single Line Symmetrical Twin */}
            <a
              href={`https://wa.me/${BUSINESS.phone.primary.replace(/\s+/g, '')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-[#0c2438]/90 hover:bg-emerald-950/40 text-white transition-all duration-200 group border border-white/10 shadow-sm whitespace-nowrap"
              title="Chat on WhatsApp"
            >
              <span className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-emerald-500 text-white flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform shadow-sm">
                <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-xs xl:text-sm font-semibold text-white tracking-normal">
                WhatsApp
              </span>
            </a>
