  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 bg-emerald-500 text-white rounded-full shadow-lg hover:bg-emerald-600 hover:scale-110 transition-all duration-300 group relative"
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 bg-[#E53935] text-white rounded-full shadow-lg hover:bg-[#c62828] hover:scale-110 transition-all duration-300 group relative"
        aria-label="Call Us"
      >
